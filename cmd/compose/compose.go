...
func RootCommand(dockerCli command.Cli, backendOptions *BackendOptions) *cobra.Command { //nolint:gocyclo
	...
	c.AddCommand(
		...
		quickCommand(&opts, dockerCli, backendOptions),
		initCommand(&opts, dockerCli, backendOptions),
		monitorCommand(&opts, dockerCli, backendOptions),
		envCommand(&opts, dockerCli, backendOptions),
		networkCommand(&opts, dockerCli, backendOptions),
		healthCommand(&opts, dockerCli, backendOptions),
		deployCommand(&opts, dockerCli, backendOptions),
		rollbackCommand(&opts, dockerCli, backendOptions),
		secretCommand(&opts, dockerCli, backendOptions),
		devCommand(&opts, dockerCli, backendOptions),
		testCommand(&opts, dockerCli, backendOptions),
		syncCommand(&opts, dockerCli, backendOptions),
		perfCommand(&opts, dockerCli, backendOptions),
		shareCommand(&opts, dockerCli, backendOptions),
